...
function topSecret(str){
  ...
  for (let i=0; i<chars.length; i++) {
    if (chars[i].charCodeAt()>=65 && chars[i].charCodeAt() <=90) {
      chars[i].charCodeAt()-3<65 ? chars[i]=String.fromCharCode(chars[i].charCodeAt()-3+26) : chars[i]=String.fromCharCode(chars[i].charCodeAt()-3)
        }                         
     if (chars[i].charCodeAt()>=97 && chars[i].charCodeAt() <=122) {
      chars[i].charCodeAt()-3<97 ? chars[i]=String.fromCharCode(chars[i].charCodeAt()-3+26) : chars[i]=String.fromCharCode(chars[i].charCodeAt()-3)
        }   
    } 
...
//question1: The to ecret file number is...
answer1= '2821';
